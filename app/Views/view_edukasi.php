                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Data Edukasi</h4>
                                    <span>This page is for managing "Edukasi".</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Edukasi</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php } else if ($row['kategori'] == 'Video') { ?>
                                                                <a class="btn btn-outline-primary" target="_blank" href="<?= $row['sumber'] ?>">
                                                                    <i class="feather icon-eye"></i>
                                                                </a>
                                                            <?php } ?>
                                                        </td>
    ...
    <form action="<?= base_url('education/delete'); ?>" enctype="multipart/form-data" method="POST">
        ...
        <div class="modal" tabindex="-1" id="deleteModal<?= $row['id']; ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title">Hapus Edukasi</h6>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
