                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Data Jadwal Hemodialisa</h4>
                                    <span>This page is for managing "Jadwal Hemodialisa".</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Jadwal Hemodialisa</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<form action="<?= base_url('jadwal/save'); ?>" enctype="multipart/form-data" method="post">
    <?= csrf_field(); ?>
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="myModalLabel">Tambah Jadwal Hemodialisa</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group" id="datetimepicker1">
                                <label>Tanggal</label>
                                <input type="date" name="jadwal" value="<?= old('jadwal') ?>" class="form-control <?= ($validation->hasError('jadwal')) ? 'is-invalid' : ''; ?>" placeholder="Masukan nik" required />
                        ...
                        <div class="col-lg-12">
                            <div class="form-group" id="datetimepicker1">
                                <label>Waktu</label>
                                <input type="time" name="waktu" value="<?= old('waktu') ?>" class="form-control <?= ($validation->hasError('waktu')) ? 'is-invalid' : ''; ?>" placeholder="Masukan nik" required />
                                <div class="invalid-feedback">
